#ifndef _ROS_SERVICE_SendTo_h
#define _ROS_SERVICE_SendTo_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char SENDTO[] = "shared_serial/SendTo";

  class SendToRequest : public ros::Msg
  {
    public:
      uint32_t socket = 0;
    ...
    const char * getType(){ return SENDTO; };
    const char * getMD5(){ return "9488c54395f85f0662ca59801f32b45a"; };

  };

  class SendToResponse : public ros::Msg
  {
    public:
      uint32_t socket = 0;
