#ifndef _ROS_pr2_controllers_msgs_Pr2GripperCommandFeedback_h
#define _ROS_pr2_controllers_msgs_Pr2GripperCommandFeedback_h
...
namespace pr2_controllers_msgs
{
  ...
  class Pr2GripperCommandFeedback : public ros::Msg
  {
    public:
      float position = 0;
      float effort = 0;
    ...
    const char * getType(){ return "pr2_controllers_msgs/Pr2GripperCommandFeedback"; };
