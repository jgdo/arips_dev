  ...
  class ControllerInfo : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 0) = (this->type >> (8 * 0)) & 0xFF;
      ...
      {
      int32_t * val_= (int32_t *) &(this->p_gain);
      ...
      *(outbuffer + offset++) = (exp_>>4) & 0x7F;
      ...
      {
      int32_t * val_= (int32_t *) &(this->i_gain);
      int32_t exp_ = (((*val_)>>23)&255);
      if(exp_ != 0)
        exp_ += 1023-127;
      int32_t sig_ = *val_;
      ...
      *(outbuffer + offset++) = (exp_>>4) & 0x7F;
      ...
      {
      int32_t * val_= (int32_t *) &(this->d_gain);
      int32_t exp_ = (((*val_)>>23)&255);
      if(exp_ != 0)
        exp_ += 1023-127;
      int32_t sig_ = *val_;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      offset += sizeof(this->type);
      {
      uint32_t * val_ = (uint32_t*) &(this->p_gain);
      offset += 3;
      ...
      *val_ |= ((uint32_t)(*(inbuffer + offset)) & 0x0f)<<19;
      ...
      {
      uint32_t * val_ = (uint32_t*) &(this->i_gain);
      offset += 3;
      *val_ = ((uint32_t)(*(inbuffer + offset++))>>5 & 0x07);
      *val_ |= ((uint32_t)(*(inbuffer + offset++)) & 0xff)<<3;
      *val_ |= ((uint32_t)(*(inbuffer + offset++)) & 0xff)<<11;
      *val_ |= ((uint32_t)(*(inbuffer + offset)) & 0x0f)<<19;
      ...
      {
      uint32_t * val_ = (uint32_t*) &(this->d_gain);
      offset += 3;
      *val_ = ((uint32_t)(*(inbuffer + offset++))>>5 & 0x07);
      *val_ |= ((uint32_t)(*(inbuffer + offset++)) & 0xff)<<3;
      *val_ |= ((uint32_t)(*(inbuffer + offset++)) & 0xff)<<11;
