#ifndef _ROS_kobuki_testsuite_ScanAngle_h
#define _ROS_kobuki_testsuite_ScanAngle_h
...
namespace kobuki_testsuite
{
  ...
  class ScanAngle : public ros::Msg
  {
    ...
    const char * getType(){ return "kobuki_testsuite/ScanAngle"; };
