...
namespace pr2_mechanism_msgs
{
  ...
  class ActuatorStatistics : public ros::Msg
  {
    public:
      ...
      float velocity = 0;
      bool calibration_reading = 0;
      bool calibration_rising_edge_valid = 0;
      bool calibration_falling_edge_valid = 0;
      float last_calibration_rising_edge = 0;
      float last_calibration_falling_edge = 0;
      bool is_enabled = 0;
      bool halted = 0;
      float last_commanded_current = 0;
      float last_commanded_effort = 0;
      float last_executed_current = 0;
      float last_executed_effort = 0;
      float last_measured_current = 0;
      float last_measured_effort = 0;
      float motor_voltage = 0;
      int32_t num_encoder_errors = 0;
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 3) = (u_.base >> (8 * 3)) & 0xFF;
      ...
      {
      int32_t * val_= (int32_t *) &(this->encoder_offset);
      ...
      *(outbuffer + offset++) = (exp_>>4) & 0x7F;
      ...
      {
      int32_t * val_= (int32_t *) &(this->encoder_velocity);
      int32_t exp_ = (((*val_)>>23)&255);
      if(exp_ != 0)
        exp_ += 1023-127;
      int32_t sig_ = *val_;
      ...
      *(outbuffer + offset++) = (exp_>>4) & 0x7F;
      ...
      u_.real = this->calibration_reading;
      *(outbuffer + offset + 0) = (u_.base >> (8 * 0)) & 0xFF;
      }
      ...
      u_.real = this->calibration_rising_edge_valid;
      *(outbuffer + offset + 0) = (u_.base >> (8 * 0)) & 0xFF;
      }
      ...
      u_.real = this->calibration_falling_edge_valid;
      *(outbuffer + offset + 0) = (u_.base >> (8 * 0)) & 0xFF;
      }
      offset += sizeof(this->calibration_falling_edge_valid);
      {
      int32_t * val_= (int32_t *) &(this->last_calibration_rising_edge);
      int32_t exp_ = (((*val_)>>23)&255);
      if(exp_ != 0)
        exp_ += 1023-127;
      int32_t sig_ = *val_;
      ...
      *(outbuffer + offset++) = (exp_>>4) & 0x7F;
      ...
      {
      int32_t * val_= (int32_t *) &(this->last_calibration_falling_edge);
      int32_t exp_ = (((*val_)>>23)&255);
      if(exp_ != 0)
        exp_ += 1023-127;
      int32_t sig_ = *val_;
      ...
      *(outbuffer + offset + 0) = (u_.base >> (8 * 0)) & 0xFF;
      ...
      {
      int32_t * val_= (int32_t *) &(this->last_commanded_current);
      int32_t exp_ = (((*val_)>>23)&255);
      if(exp_ != 0)
        exp_ += 1023-127;
      int32_t sig_ = *val_;
      ...
      *(outbuffer + offset++) = (exp_>>4) & 0x7F;
      ...
      {
      int32_t * val_= (int32_t *) &(this->last_commanded_effort);
      int32_t exp_ = (((*val_)>>23)&255);
      if(exp_ != 0)
        exp_ += 1023-127;
      int32_t sig_ = *val_;
      ...
      *(outbuffer + offset++) = (exp_>>4) & 0x7F;
      ...
      {
      int32_t * val_= (int32_t *) &(this->last_executed_current);
      int32_t exp_ = (((*val_)>>23)&255);
      if(exp_ != 0)
        exp_ += 1023-127;
      int32_t sig_ = *val_;
      ...
      *(outbuffer + offset++) = (exp_>>4) & 0x7F;
      ...
      {
      int32_t * val_= (int32_t *) &(this->last_executed_effort);
      int32_t exp_ = (((*val_)>>23)&255);
      if(exp_ != 0)
        exp_ += 1023-127;
      int32_t sig_ = *val_;
      ...
      *(outbuffer + offset++) = (exp_>>4) & 0x7F;
      ...
      {
      int32_t * val_= (int32_t *) &(this->last_measured_current);
      int32_t exp_ = (((*val_)>>23)&255);
      if(exp_ != 0)
        exp_ += 1023-127;
      int32_t sig_ = *val_;
      ...
      *(outbuffer + offset++) = (exp_>>4) & 0x7F;
      ...
      {
      int32_t * val_= (int32_t *) &(this->last_measured_effort);
      int32_t exp_ = (((*val_)>>23)&255);
      if(exp_ != 0)
        exp_ += 1023-127;
      int32_t sig_ = *val_;
      ...
      *(outbuffer + offset++) = (exp_>>4) & 0x7F;
      ...
      {
      int32_t * val_= (int32_t *) &(this->motor_voltage);
      int32_t exp_ = (((*val_)>>23)&255);
      if(exp_ != 0)
        exp_ += 1023-127;
      int32_t sig_ = *val_;
      ...
      *(outbuffer + offset++) = (exp_>>4) & 0x7F;
      ...
      u_.real = this->num_encoder_errors;
      *(outbuffer + offset + 0) = (u_.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_.base >> (8 * 3)) & 0xFF;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      u_.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      this->encoder_count = u_.real;
      }
      offset += sizeof(this->encoder_count);
      {
      uint32_t * val_ = (uint32_t*) &(this->encoder_offset);
      offset += 3;
      ...
      *val_ |= ((uint32_t)(*(inbuffer + offset)) & 0x0f)<<19;
      ...
      {
      uint32_t * val_ = (uint32_t*) &(this->encoder_velocity);
      offset += 3;
      *val_ = ((uint32_t)(*(inbuffer + offset++))>>5 & 0x07);
      *val_ |= ((uint32_t)(*(inbuffer + offset++)) & 0xff)<<3;
      *val_ |= ((uint32_t)(*(inbuffer + offset++)) & 0xff)<<11;
      ...
      *val_ |= ((uint32_t)(*(inbuffer + offset)) & 0x0f)<<19;
      ...
      this->calibration_reading = u_.real;
      }
      offset += sizeof(this->calibration_reading);
      {
      union {
      ...
      u_.base = 0;
      u_.base |= ((uint8_t) (*(inbuffer + offset + 0))) << (8 * 0);
      this->calibration_rising_edge_valid = u_.real;
      }
      offset += sizeof(this->calibration_rising_edge_valid);
      {
      union {
      ...
      u_.base = 0;
      u_.base |= ((uint8_t) (*(inbuffer + offset + 0))) << (8 * 0);
      this->calibration_falling_edge_valid = u_.real;
      }
      offset += sizeof(this->calibration_falling_edge_valid);
      {
      uint32_t * val_ = (uint32_t*) &(this->last_calibration_rising_edge);
      offset += 3;
      *val_ = ((uint32_t)(*(inbuffer + offset++))>>5 & 0x07);
      *val_ |= ((uint32_t)(*(inbuffer + offset++)) & 0xff)<<3;
      *val_ |= ((uint32_t)(*(inbuffer + offset++)) & 0xff)<<11;
      *val_ |= ((uint32_t)(*(inbuffer + offset)) & 0x0f)<<19;
      ...
      {
      uint32_t * val_ = (uint32_t*) &(this->last_calibration_falling_edge);
      offset += 3;
      *val_ = ((uint32_t)(*(inbuffer + offset++))>>5 & 0x07);
      *val_ |= ((uint32_t)(*(inbuffer + offset++)) & 0xff)<<3;
      *val_ |= ((uint32_t)(*(inbuffer + offset++)) & 0xff)<<11;
      *val_ |= ((uint32_t)(*(inbuffer + offset)) & 0x0f)<<19;
      ...
      offset += sizeof(this->halted);
      {
      uint32_t * val_ = (uint32_t*) &(this->last_commanded_current);
      offset += 3;
      *val_ = ((uint32_t)(*(inbuffer + offset++))>>5 & 0x07);
      *val_ |= ((uint32_t)(*(inbuffer + offset++)) & 0xff)<<3;
      *val_ |= ((uint32_t)(*(inbuffer + offset++)) & 0xff)<<11;
      *val_ |= ((uint32_t)(*(inbuffer + offset)) & 0x0f)<<19;
      ...
      {
      uint32_t * val_ = (uint32_t*) &(this->last_commanded_effort);
      offset += 3;
      *val_ = ((uint32_t)(*(inbuffer + offset++))>>5 & 0x07);
      *val_ |= ((uint32_t)(*(inbuffer + offset++)) & 0xff)<<3;
      *val_ |= ((uint32_t)(*(inbuffer + offset++)) & 0xff)<<11;
      *val_ |= ((uint32_t)(*(inbuffer + offset)) & 0x0f)<<19;
      ...
      {
      uint32_t * val_ = (uint32_t*) &(this->last_executed_current);
      offset += 3;
      *val_ = ((uint32_t)(*(inbuffer + offset++))>>5 & 0x07);
      *val_ |= ((uint32_t)(*(inbuffer + offset++)) & 0xff)<<3;
      *val_ |= ((uint32_t)(*(inbuffer + offset++)) & 0xff)<<11;
      *val_ |= ((uint32_t)(*(inbuffer + offset)) & 0x0f)<<19;
      ...
      {
      uint32_t * val_ = (uint32_t*) &(this->last_executed_effort);
      offset += 3;
      *val_ = ((uint32_t)(*(inbuffer + offset++))>>5 & 0x07);
      *val_ |= ((uint32_t)(*(inbuffer + offset++)) & 0xff)<<3;
      *val_ |= ((uint32_t)(*(inbuffer + offset++)) & 0xff)<<11;
      *val_ |= ((uint32_t)(*(inbuffer + offset)) & 0x0f)<<19;
      ...
      {
      uint32_t * val_ = (uint32_t*) &(this->last_measured_current);
      offset += 3;
      *val_ = ((uint32_t)(*(inbuffer + offset++))>>5 & 0x07);
      *val_ |= ((uint32_t)(*(inbuffer + offset++)) & 0xff)<<3;
      *val_ |= ((uint32_t)(*(inbuffer + offset++)) & 0xff)<<11;
      *val_ |= ((uint32_t)(*(inbuffer + offset)) & 0x0f)<<19;
      ...
      {
      uint32_t * val_ = (uint32_t*) &(this->last_measured_effort);
      offset += 3;
      *val_ = ((uint32_t)(*(inbuffer + offset++))>>5 & 0x07);
      *val_ |= ((uint32_t)(*(inbuffer + offset++)) & 0xff)<<3;
      *val_ |= ((uint32_t)(*(inbuffer + offset++)) & 0xff)<<11;
      *val_ |= ((uint32_t)(*(inbuffer + offset)) & 0x0f)<<19;
      ...
      {
      uint32_t * val_ = (uint32_t*) &(this->motor_voltage);
      offset += 3;
      *val_ = ((uint32_t)(*(inbuffer + offset++))>>5 & 0x07);
      *val_ |= ((uint32_t)(*(inbuffer + offset++)) & 0xff)<<3;
      *val_ |= ((uint32_t)(*(inbuffer + offset++)) & 0xff)<<11;
      *val_ |= ((uint32_t)(*(inbuffer + offset)) & 0x0f)<<19;
      ...
      u_.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      this->num_encoder_errors = u_.real;
      }
      offset += sizeof(this->num_encoder_errors);
     return offset;
    }
