#ifndef _ROS_SERVICE_ListNodes_h
#define _ROS_SERVICE_ListNodes_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char LISTNODES[] = "multimaster_msgs_fkie/ListNodes";

  class ListNodesRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return LISTNODES; };
    const char * getMD5(){ return "d41d8cd98f00b204e9800998ecf8427e"; };

  };

  class ListNodesResponse : public ros::Msg
  {
    public:
